...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div
      className={cn(
        "wazen-app-canvas min-h-screen",
        profile?.life_stage === "teenager" && "stage-teen",
        profile?.life_stage === "university_student" && "stage-university",
      )}
    >
      ...
      <WazenLocaleProvider language={profile?.language}>
        <main className="mx-auto max-w-6xl px-3 pb-[calc(7.5rem+env(safe-area-inset-bottom))] pt-6 min-[375px]:px-4 sm:px-6 sm:pt-9 lg:px-8 lg:pb-14">
          {children}
        </main>
      </WazenLocaleProvider>
