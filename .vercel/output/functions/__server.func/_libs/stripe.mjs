...
//#endregion
//#region node_modules/stripe/esm/StripeEmitter.js
/**
* @private
...
//#endregion
//#region node_modules/stripe/esm/platform/WebPlatformFunctions.js
/**
...
var Stripe = class Stripe {
	...
	*/
	_setAuthenticator(key, authenticator) {
		if (!key && !authenticator) authenticator = this._platformFunctions.createDefaultAuthenticator();
	...
	*/
	getClientUserAgentSeeded(seed, cb) {
		...
		if (this.getTelemetryEnabled()) {
			...
			if (telemetryId) userAgent.telemetry_id = telemetryId;
		}
	...
	*/
	...
	_buildEventNotification(parsed) {
		if (parsed.object === "event") throw new Error("You passed a v1 Event to a method that expects a thin event notification. Use the corresponding constructEvent method instead.");
		if (parsed.object != null && parsed.object !== "v2.core.event") throw new Error(`Unexpected object type '${parsed.object}'. Expected 'v2.core.event' for an event notification.`);
...
//#endregion
export { stripe_esm_worker_default as t };
